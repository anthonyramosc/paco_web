...
const Navbar: React.FC = () => {
    ...
    const socialLinks = {
        ...
        share: "https://wa.me/?text=Visita%20nuestro%20proyecto%20social:%20https://tuproyecto.com"
    };
                    ...
                    <div className="ul-header-top flex items-center justify-center gap-40">
                        ...
                        <div className="flex space-x-2">
                            ...
                            <a
                                ...
                                className="bg-white text-indigo-500 p-2 rounded-md hover:bg-indigo-100 transition-colors"
                            >

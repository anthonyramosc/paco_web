        ...
        <div className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
            ...
            <header className="ul-header">
                <div className="header-top-bg-wrapper">
                    <div className="ul-header-top flex items-center justify-center gap-40">
                        <div className="font-bold text-xl md:text-2xl">
                            <TypedText />
                        </div>

                        <div className="md:flex z-10 flex gap-20 mr-20">
                            <button
                                onClick={() => scrollToComponent('profileComponent')}
                                className="text-[#785D99] !no-underline text-lg cursor-pointer"
                        ...
                        <div className="flex space-x-2">
                            {/* Facebook - Color cambiado a #785D99 */}
                            <a
                                href={socialLinks.facebook}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="bg-white text-[#785D99] p-2 rounded-md hover:bg-indigo-100 transition-colors"
                            >
                            ...
                            {/* Instagram - Color cambiado a #785D99 */}
                            <a
                            ...
                            {/* TikTok - Color cambiado a #785D99 */}
                            <a
                            ...
                            {/* Share button - Color cambiado a #785D99 y actualizada la URL */}
                            <a

...
const Navbar = () => {
    ...
    const navLinks = [
        { id: 'profileComponent', label: 'Conoceme' },
        { id: 'donateComponent', label: 'Donaciones' },
        { id: 'prothesisComponent', label: 'Noticias' },
        { id: 'segmentationComponent', label: 'Metricas' },
        { id: 'contactComponent', label: 'Contactame' }
    ];
                                ...
                                <div className="flex flex-col space-y-4">
                                    {navLinks.map((link) => (
                                        <button
                                            key={link.id}
                                            onClick={() => scrollToComponent(link.id)}
                                            className="text-white !no-underline text-lg cursor-pointer font-bold"
                                        >
                                            {link.label}
                                        </button>
                                    ))}
